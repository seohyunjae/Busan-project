...
Shader "LowPoly/SimpleWater"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float2 panner22 = ( uv_WaterNormal + 0.0 * _Time.y * float2( 0,0 ));
			float2 panner19 = ( uv_WaterNormal + 0.0 * _Time.y * float2( 0,0 ));
			...
			float2 panner116 = ( uv_Foam + 0.0 * _Time.y * float2( 0,0 ));
